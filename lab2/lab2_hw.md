...
Vectors are a standard way of organizing data in R in a clean way.

2. What is a data matrix in R?  

A data matrix is a way of stacking vectors in R to create data tables for instance.
...
```r
new_spring_matrix <- cbind(spring_matrix, Mean)
new_spring_matrix
```
