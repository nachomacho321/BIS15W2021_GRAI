...
Yes the data is tidy. Variables are individually defined within each column which makes this tidy. This data is in long format.
...
##   year  site        avg_bact
##   <chr> <chr>          <dbl>
## 1 2014  Bondi Beach     11.1
## 2 2017  Bondi Beach     13.2
## 3 2015  Bondi Beach     14.3
## 4 2016  Bondi Beach     19.4
## 5 2018  Bondi Beach     22.9
## 6 2013  Bondi Beach     32.2
```
