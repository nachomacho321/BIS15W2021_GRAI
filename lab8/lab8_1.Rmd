...
Income and number of observations are seperate variables but we have number of observations listed under income.Also the column names represent multiple instances of the same variable. 
...
The column names are one variable and the rows under them make up a different variable.
