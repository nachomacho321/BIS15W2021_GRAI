...
The variables are named below next to the $ symbols. Our dimensions are 17,692x71. Our classes of variables are chr and dlb, and there are NAs present in the data
...
```
## # A tibble: 1,471 x 3
##    asfis_species_name    high_species n_total
##    <chr>                        <dbl>   <int>
...
```
## # A tibble: 28 x 3
##    isscaap_taxonomic_group       recent_catch n_total
##    <chr>                                <dbl>   <int>
##  1 Cods, hakes, haddocks                61502     223
##  2 Herrings, sardines, anchovies        17451     179
##  3 Clams, cockles, arkshells            17263     224
##  4 Miscellaneous coastal fishes         14102    1077
##  5 Salmons, trouts, smelts              11059     134
##  6 Flounders, halibuts, soles            9360     472
##  7 Tunas, bonitos, billfishes            9072     642
##  8 Miscellaneous demersal fishes         9064     565
##  9 Miscellaneous pelagic fishes          7937     585
## 10 Sharks, rays, chimaeras               6894     537
## # ... with 18 more rows
```
